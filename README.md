...
Certifique-se de ter o framework Flask instalado.
...
http://127.0.0.1:5000/mostrar_lista - <b>"/mostrar_lista"</b> é a página exibida após o login, mostrando os nomes dos usuários já criados. <br>  
http://127.0.0.1:5000/criar - <b>"/criar"</b> é onde um novo usuário é criado. <br>  

<i>Você deve estar logado para acessar a página <b>"/mostrar_lista"</b>.</i>

Inicialmente, não haverá usuários, então crie-os e experimente como o sistema funciona. Caso encontre algum problema, por favor, me avise por e-mail, se possível.
